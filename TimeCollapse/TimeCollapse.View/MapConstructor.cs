...
namespace TimeCollapse.View
{
    public sealed class MapConstructor : UserControl
    {
        ...
        public MapConstructor(MainForm form)
        {
            ...
            var instruction = Instruction(new Size(700, 520));
